...
Plagát k~bakalárskej práci je zobrazený na obr.~\ref{fig:priloha-plagat}.

\begin{figure}[H]
  \centering
  \IfFileExists{poster.pdf}{%
    \includegraphics[page=1,width=\textwidth,height=0.65\textheight,keepaspectratio]{poster.pdf}%
  }{%
  \IfFileExists{poster/PosterTemplate.pdf}{%
    \includegraphics[page=1,width=\textwidth,height=0.76\textheight,keepaspectratio]{poster/PosterTemplate.pdf}%
  }{%
    \includegraphics[width=\textwidth,height=0.76\textheight,keepaspectratio]{obrazky/poster.png}%
  }}
  \caption{Plagát k~bakalárskej práci}
  \label{fig:priloha-plagat}
\end{figure}
