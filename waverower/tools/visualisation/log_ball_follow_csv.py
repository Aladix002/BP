...
#   ros2 run waverower log_ball_follow_csv.py --ros-args -p output_file:=/tmp/ball_follow.csv
# Spusti pocas ball_follow_standalone; pre pwm_* musi bezat waverower_motor (drive_debug).
