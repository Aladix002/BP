...
function App() {
  ...
  return (
    <div className="max-w-[960px] mx-auto px-3 sm:px-5 py-4 pb-10">
      ...
      <WR.ConnectionCard ros={ros} wsUrl={wsUrl} setWsUrl={setWsUrl} connected={connected} connect={connect} disconnect={disconnect} />
      <WR.ModeCard ros={ros} connected={connected} />
      <div className="grid grid-cols-2 gap-2 mb-2">
        <WR.CameraPanel ros={ros} connected={connected} />
